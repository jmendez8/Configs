...
# Lock screen
bindsym $mod+l exec i3lock --color=000000 --show-failed-attempts

# passmenu
bindsym $mod+Shift+P exec passmenu

# RDP
#bindsym $mod+p          exec rdp
...
### Open workspaces on specific outputs
# Primary monitor, DP-1
workspace 1 output DP-1
workspace 2 output DP-1
workspace 3 output DP-1

# Secondary monitor, HDMI-2
...
# Fous window on click
focus_follows_mouse no

# volumeicon in i3bar
exec --no-startup-id volumeicon

# Automatic back and forth switching
...
# Moves to window that has an urgent message
